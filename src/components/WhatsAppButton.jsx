...
import { sediAttive, sedeUnica, waHref } from '../data/sedi'
...
export default function WhatsAppButton({ isHidden = false }) {
  ...
  // Con una sola sede attiva si apre direttamente la chat, senza pannello.
  if (sedeUnica) {
    return (
      <a
        ...
        aria-label={`Contatta su WhatsApp — ${sedeUnica.nome}`}
        className="fixed bottom-20 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-lg hover:shadow-xl transition-all text-white"
